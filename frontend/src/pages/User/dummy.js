  ...
  return (
    <div className="chat-container">
      ...
      <div class="flex-1 p:2 sm:p-6 justify-between flex flex-col msg_divs">
        ...
        <div id="messages" class="chat-messages flex flex-col space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
          {messages.map((items) => {
            if (items.text) {
        ...
        < div class="chat-input border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0" >
