    ...
    <div>
      ...
      <div className="flex justify-center items-center h-screen" >
        ...
        <div>
          {/* Course Category */}
          <div className="mb-4">
            <span className="text-lg font-bold">{courseDetail.category}</span>
          </div>

          {/* Course Name */}
          <div className="mb-4">
            <span className="text-lg font-bold">{courseDetail.course_name}</span>
          </div>
          ...
          {/* Purchase Button */}
          <div>
            <button onClick={() => fullPayment(courseDetail.amount, courseDetail._id)} className="px-4 py-2 bg-blue-500 text-white rounded cursor-pointer">
              Purchase
            </button>
          </div>
        </div>
